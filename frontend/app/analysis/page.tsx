...
function AnalysisContent() {
  ...
  return (
    <main className="min-h-screen px-4 py-10 max-w-5xl mx-auto">
      ...
      {phase === "done" && (
        <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 mb-6 text-green-400 flex items-center justify-between gap-2">
          ...
          {sessionId && (
            <a
              ...
              className="shrink-0 text-sm bg-green-500/20 border border-green-500/40 hover:bg-green-500/30 text-green-300 px-3 py-1.5 rounded-lg transition-colors"
            >
